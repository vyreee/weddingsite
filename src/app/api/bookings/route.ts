...
export async function POST(request: NextRequest) {
  try {
    ...
    const bookingData = {
      ...
      church_venue_name: body.churchVenueName,
      church_venue_address: body.churchVenueAddress,
      church_google_maps_link: body.churchGoogleMapsLink,
      reception_venue_name: body.receptionVenueName,
      reception_venue_address: body.receptionVenueAddress,
      reception_google_maps_link: body.receptionGoogleMapsLink,
